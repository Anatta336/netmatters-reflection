...
class PostsViewTest extends TestCase
{
    ...
    public function testGenerateHtmlForAPost(): void
    {
        ...
        <a class="lead" href="https://www.netmatters.co.uk/online-art-gallery-case-study">
        <picture>
        ...
        <a href="https://www.netmatters.co.uk/online-art-gallery-case-study">
        <h3>Online Art Gallery Case Study</h3>
        </a>
        <p>We made an online art gallery, and it was really successful&#8230;</p>
        <a class="button" href="https://www.netmatters.co.uk/online-art-gallery-case-study" aria-label="Read more">
        Read More
        </a>
        <div class="poster">
        <picture>
